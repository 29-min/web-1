      ...
      <div className="max-w-5xl mx-auto">
        ...
        <header className="text-center py-16 md:py-24">
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
            AI 기반 콘텐츠 도구 모음<br />
            블로그 글을 SNS로 변환하거나, 원하는 스타일의 프롬프트를 추출하세요
          </p>
        </header>
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          ...
          <Link href="/extract-prompt" className="group">
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-lg border border-white/20 p-8 h-full transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] hover:border-amber-200">
              ...
              <p className="text-slate-500 leading-relaxed">
                블로그 URL을 입력하면 해당 글의 <strong className="text-amber-600">톤앤매너</strong>를 분석하여
                동일한 스타일로 글을 쓸 수 있는 <strong className="text-orange-600">프롬프트 템플릿</strong>을 생성합니다.
              </p>
              <div className="mt-6 flex flex-wrap gap-2">
                ...
                <span className="px-3 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-semibold">프롬프트 생성</span>
              </div>
            </div>
          </Link>
        </div>
